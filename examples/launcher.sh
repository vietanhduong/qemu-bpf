...
DISK_IMAGE=${BUILDS_DIR}/qemu-5.15.101.qcow2
BAZEL_RUN_SSHD_PATH=$REPO_ROOT/examples/run_sshd.sh
RUN_QEMU_SCRIPT=$REPO_ROOT/examples/run_qemu.sh
OLDPWD=$REPO_ROOT
